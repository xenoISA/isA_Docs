...
`isa-orch test-scaffold` creates the standard isA test directory structure described in [Generated Structure](#generated-structure). It's idempotent — running it multiple times on a project that's already scaffolded is safe.
