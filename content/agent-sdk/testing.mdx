...
- `auth_service`: `http://localhost:8201`
- agent A: `http://localhost:8101`
- agent B: `http://localhost:8102`
...
- `POST /api/v1/a2a/test-client` on 8101
- target: `http://localhost:8102/a2a`
- result: success with JSON-RPC response

See full setup and code examples: [A2A guide](./a2a)
